...
# 1. Auto-cleanup of mp3/mp4/images after delivery
# 2. Better FFmpeg error logging
# 3. Retry logic for image downloads
# 4. Progress messages during MP4 generation
# 5. Safer filename sanitization
# 6. OpenRouter fallback model support
